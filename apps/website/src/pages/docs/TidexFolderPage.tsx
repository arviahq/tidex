...
export function TidexFolderPage() {
  return (
    <DocPage
      title=".tidex folder"
      description="Tidex writes generated artifacts, test files, and visual baselines to .tidex/ at the package root where you run commands."
    >
      <section className="doc-section">
        <h2>Overview</h2>
        <p>
          The <code>.tidex/</code> directory is created on <code>tidex init</code> and populated on{" "}
          <code>tidex generate</code>. The manager and CLI read from it at dev and test time. Most
          files are regenerated on every scan — treat them as build output, not hand-edited source.
        </p>
        <p>
          Run all Tidex commands from the package that owns <code>tidex.config.ts</code> — that
          package&apos;s <code>.tidex/</code> is the one that matters.
        </p>
      </section>
...
├── config.json                # snapshot of tidex.config.ts options
...
└── reports/                   # run output (gitignored)
    ...
    └── Button-diff.json`}
      ...
      <section className="doc-section">
        ...
        <p>
          Rewritten by <code>tidex generate</code> (and automatically during <code>tidex dev</code>{" "}
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                  ...
                  <code>componentsDir</code> from <code>tidex.config.ts</code>.
                </td>
              </tr>
              <tr>
                <td>
      ...
      <section className="doc-section">
        <h2>Git</h2>
        <p>
          <code>tidex init</code> adds rules to <code>.gitignore</code> so generated artifacts stay
          local, with two exceptions you typically commit:
        </p>
        <CodeBlock
          language="text"
          code={`# Tidex generated artifacts (commit baselines + interaction wiring)
.tidex/*
!.tidex/baselines/
!.tidex/baselines/**
!.tidex/interactions/
!.tidex/interactions/**`}
        ...
        <ul>
          <li>
            <strong>Commit</strong> <code>.tidex/baselines/</code> — visual regression needs shared
            baselines across the team and CI.
          </li>
          <li>
            <strong>Commit</strong> <code>.tidex/interactions/</code> — callback wiring overrides
            are team-owned configuration.
          </li>
          <li>
            <strong>Gitignored</strong> — everything else under <code>.tidex/</code>, including{" "}
        ...
        <p>
          ...
          <code>.tidex/tests/</code> or copy tests into your own fixture layout.
        </p>
      </section>
          ...
          <table className="doc-table">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                  <code>.tidex/tests/{"{componentId}"}.json</code>
                </td>
              </tr>
              <tr>
                <td>Manager Interactions tab</td>
                <td>
                  <code>.tidex/interactions/{"{componentId}"}.json</code>
                </td>
              </tr>
              <tr>
                <td>
                  <code>tidex visual --update</code> or Visual tab
                </td>
                <td>
                  <code>.tidex/baselines/</code> PNG + snapshot files
                </td>
              </tr>
              <tr>
                <td>
                  <code>tidex test</code> / <code>tidex visual</code>
                </td>
                <td>
                  <code>.tidex/reports/</code> outputs
                </td>
              </tr>
            </tbody>
          </table>
      ...
      <section className="doc-section">
        ...
        <ul>
          ...
          <li>
            <Link to="/docs/quick-start">Quick start</Link> — <code>tidex init</code>,{" "}
            <code>tidex generate</code>, and testing commands
          </li>
        </ul>
      </section>
    </DocPage>
