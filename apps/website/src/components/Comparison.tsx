const ROWS = [
  {
    label: "Story files",
    storybook: "Write .stories.tsx for every component",
    tidex: "Scan src/**/*.tsx automatically",
  },
  {
    label: "Prop controls",
    storybook: "Hand-written argTypes",
    tidex: "Inferred from TypeScript types",
  },
  { label: "Accessibility", storybook: "Addon + setup", tidex: "Built-in, run with tidex test" },
  {
    label: "Visual regression",
    storybook: "Chromatic or custom addon",
    tidex: "tidex visual + in-app diff review",
  },
  {
    label: "Interaction tests",
    storybook: "play functions in stories",
    tidex: "Tests tab + .tidex/tests/*.json",
  },
  {
    label: "Design tokens",
    storybook: "Addon or custom panel",
    tidex: "Foundations → Tokens from config",
  },
  {
    label: "Config surface",
    storybook: "main.ts + preview.ts + addons",
    tidex: "tidex.config.ts + tidex init",
  },
  {
    label: "Monorepo",
    storybook: "Per-package or shared config",
    tidex: "Run from the owning package",
  },
];
      ...
      <div className="section__inner">
        <div className="section__header">
          ...
          <h2 className="section__title">
            Storybook made you maintain two codebases. Tidex doesn&apos;t.
          </h2>
