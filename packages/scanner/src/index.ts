...
function generateStoriesFile(root: string, manifest: Manifest, props: PropsMap, config: TideConfig): string {
  ...
  for (const component of manifest.components) {
    ...
    const relImport = path.relative(tideDirAbs, path.join(root, component.path)).replace(/\\/g, "/");
...
export { buildScanDiagnostics, formatScanDiagnostics, type ScanDiagnostics } from "./diagnostics.js";
