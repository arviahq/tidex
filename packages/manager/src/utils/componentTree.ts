...
/** A top-level sidebar section, derived from a component id's first folder. */
 ...
 * segment). Top-level components with no folder fall under a default
 * "Components" section. Sections merge case-insensitively so inconsistent
 * folder casing ("Forms" vs "forms") doesn't split into two headers.
 */
